...
public interface UserOperations {
     ...
     * Get a range of recent media of a specific user
     * @param userId
     * @param count Number of media items to retrieve
     * @param maxId Get media before this ID
     * @param minId Get media after this ID
     * @return  List of media
     */
	 PagedMediaList getRecentMedia(String userId, int count, String maxId, String minId);
     ...
     * @return  List of media
     */
	 PagedMediaList getRecentMedia(String userId, int count, String minId);
